...
from spotify_app.cred import SPOTIPY_CLIENT_ID,SPOTIPY_CLIENT_SECRET, SPOTIPY_REDIRECT_URI
...
def top_tracks():
    ...
    if access_token != None:
        ...
        top_tracks = get_request(access_token, "https://api.spotify.com/v1/tracks?ids=0WtM2NBVQNNJLh6scP13H8,6ocbgoVGwYJhOv1GgI9NsF,0dIoGTQXDh1wVnhIiSyYEa,0QBzMgT7NIeoCYy3sJCof1,5wANPM4fQCJwkGd4rN57mH,7kdmDLwyzFL8jYLzfMvPwQ,6RUKPb4LETWmmr3iAEQktW,6OcCk1dbAb7XNHsC098oEM")
...
def home():
    access_token = getToken()
    if access_token != None:
        top_artists  = get_artist(access_token, "https://api.spotify.com/v1/artists?ids=66CXWjxzNUsdJxJ2JdwvnR,0C8ZW7ezQVs4URX5aX7Kqx,7n2wHs1TKAczGzO7Dd2rGr,6vWDO969PvNqNYHIOW5v0m,7dGJo4pcD2V6oG8kP0tJRR,4kYSro6naA4h99UJvo89HB,4Ns55iOSe1Im2WU2e1Eym0,246dkjvS1zLTtiykXe5h60")
